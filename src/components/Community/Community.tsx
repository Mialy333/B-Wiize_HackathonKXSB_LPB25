              ...
              <div className="flex items-center">
                ...
                <div>
                  ...
                  >
                    Created{" "}
                    {data?.stats.founded
                      ? new Date(data.stats.founded).toLocaleDateString(
                          "en-US",
                          {
                            month: "long",
                            year: "numeric",
              ...
              {sortedPosts.map((post) => (
                <PostCard
                  ...
                  onCommentVote={(commentId, voteType) =>
                    handleCommentVote(post.id, commentId, voteType)
                  }
                  onReplyVote={(commentId, replyId, voteType) =>
                    handleReplyVote(post.id, commentId, replyId, voteType)
                  }
                  ...
                  replyData={
                    replyData && replyData.postId === post.id ? replyData : null
                  }
                  onReplyTextChange={(text) =>
                    setReplyData({ ...replyData!, text })
                  }
          ...
          >
            ...
            <div className="space-y-4">
              ...
              >
                ...
                >
                  Use student discounts for everything - always ask if they're
                  available
                </p>
              </div>
              <div
